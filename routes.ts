...
const models: TsoaRoute.Models = {
    "GetUser": {
        ...
        "properties": {
            ...
            "status": {"dataType":"union","subSchemas":[{"dataType":"enum","enums":["active"]},{"dataType":"enum","enums":["disabled"]}],"required":true},
        },
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/api/register',
            ...
            ...(fetchMiddlewares<RequestHandler>(RegisterController.prototype.createUser)),

            async function RegisterController_createUser(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsRegisterController_createUser, request, response });
